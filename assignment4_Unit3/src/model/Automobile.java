...
public class Automobile implements Serializable {
	 ...
	 * Automobile class methods need to synchronized in case CRUN operated 
	 * at the same time.
	 */
	...
	public synchronized void setOption(int optSetIndex, int optIndex, String optionName,
			float price) {
		// set option
	...
	public synchronized void setOptionSet(int index, String optsetName, int optSize) {
		// set OptionSet
		if (index < optionSetSize) {
