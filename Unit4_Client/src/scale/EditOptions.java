...
public class EditOptions extends Thread {
	/**
	 * EditOptions use synchronized methods in the Automobile class to operate
	 * on Automobile LinkedHashMap instance in proxyAutomotive
	 */
	...
	public void run() {
		buildAuto.setAutoOptionChoice(this.modelName, this.optionSetName,
				this.optionName);
